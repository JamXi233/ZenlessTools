...
namespace ZenlessTools.Views
{
    public sealed partial class AboutView : Page
    {
        ...
        private async void AboutView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            appVersion.Text = $"ZenlessTools {Package.Current.Id.Version.Major}.{Package.Current.Id.Version.Minor}.{Package.Current.Id.Version.Build}.{Package.Current.Id.Version.Revision}";
            GetVersionButton();
            CheckFont();
            LoadSettings();
        ...
        private async void Backup_Data(object sender, RoutedEventArgs e)
        {
            ...
            savePicker.FileTypeChoices.Add("Zip Archive", new List<string>() { ".ZenlessToolsBackup" });
            savePicker.SuggestedStartLocation = PickerLocationId.DocumentsLibrary;
            savePicker.SuggestedFileName = "ZenlessTools_Backup_" + formattedDate;
        ...
        private async void Restore_Data()
        {
            ...
            picker.FileTypeFilter.Add(".ZenlessToolsBackup");
            var window = new Window();
            var hwnd = WinRT.Interop.WindowNative.GetWindowHandle(window);
            ...
            try
            {
                ...
                if (file != null)
                {
                    ...
                    Task.Run(() => ZipFile.ExtractToDirectory(file.Path, userDocumentsFolderPath + "\\JSG-LLC\\ZenlessTools\\")).Wait();
