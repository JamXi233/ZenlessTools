...
namespace ZenlessTools.Views.GachaViews
{
    public sealed partial class ScreenShotGacha : Page
    {
        ...
        public async Task CaptureScreenshotAsync(UIElement element)
        {
            try
            {
                ...
                string zenlessToolsFolderPath = Path.Combine(jsgFolderPath, "ZenlessTools");
                string gachaScreenshotsFolderPath = Path.Combine(zenlessToolsFolderPath, "GachaScreenshots");
